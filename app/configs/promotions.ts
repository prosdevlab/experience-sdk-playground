...
export const flashSaleBanner: Experience = {
  ...
  content: {
    ...
    message: '20-40% Off Almost Everything | Free Shipping On Orders Over $99. Take additional 65% off with PROMO: <strong>WNTR011026</strong>',
    dismissable: true,
...
export const featureAnnouncementBanner: Experience = {
  ...
  content: {
    ...
    message: 'Get real-time insights with machine learning. Track conversions, predict trends, and optimize campaigns—all in one place.',
    buttons: [
      {
...
export const compactPromoBanner: Experience = {
  ...
  type: 'banner',
  content: {
    message: '<strong>Ends in 5h 59m 32s.</strong> One last deal | You\'ve shopped for others. Now, get something for you. 5 impressions banner.',
    buttons: [],
    dismissable: true,
