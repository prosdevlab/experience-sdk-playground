...
import { ArrowLeft, Megaphone, Target, Lightbulb, Rocket } from 'lucide-react';
      ...
      <main className="max-w-6xl mx-auto px-6 py-12">
        ...
        <div className="mb-12">
          ...
          <p className="text-lg text-zinc-600 dark:text-zinc-400 max-w-3xl">
            Drive conversions with timely, targeted promotional messages. Perfect for sales,
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-zinc-600 dark:text-zinc-400 mb-4">
                  Check out the Banner Layout Gallery for visual references, styling options, and customization examples.
                </p>
                <Link
                  href="/layout-gallery/banner"
        ...
        <div className="mt-12 p-6 bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800 rounded-lg">
          ...
          <ul className="space-y-2 text-sm text-zinc-700 dark:text-zinc-300">
            <li>
              <strong>Frequency capping:</strong> Limit to 3 impressions per day to avoid
              banner fatigue
            </li>
            <li>
              <strong>Always dismissable:</strong> Give users control to close the banner
            </li>
            <li>
              <strong>URL targeting:</strong> Show relevant offers based on page context
            </li>
            <li>
              <strong>A/B testing:</strong> Test different messages, CTAs, and placements
            </li>
            <li>
              <strong>Mobile-first:</strong> Keep messages concise for small screens
            </li>
            <li>
              <strong>Clear CTAs:</strong> Use action verbs and make buttons stand out
            </li>
          </ul>
        </div>
        ...
        <div className="mt-8 p-6 bg-purple-50 dark:bg-purple-950/30 border border-purple-200 dark:border-purple-800 rounded-lg">
          ...
          <p className="text-sm text-zinc-700 dark:text-zinc-300 mb-3">
            Target promotions to specific user segments using Lytics audience data:
          </p>
          <ul className="space-y-2 text-sm text-zinc-700 dark:text-zinc-300">
